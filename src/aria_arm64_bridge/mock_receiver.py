...
Simulates the same ZMQ protocol (v2) as the real receiver but with synthetic data.
Does NOT require FEX-Emu or the Aria SDK.

Usage (native):
    python3 -m aria_arm64_bridge.mock_receiver
    python3 -m aria_arm64_bridge.mock_receiver --fps 15 --width 640 --height 480

Usage (under FEX-Emu, to test cross-process):
    PYTHONNOUSERSITE=1 FEXBash -c "python3 -m aria_arm64_bridge.mock_receiver"
"""
...
# Protocol v2 constants (must match aria_arm64_bridge/protocol.py)
