...
CONFIGS=(
  "profile12|$ALLS|profile12 — all sensors (current baseline)"
  "profile12|slam|profile12 — SLAM-only (nav ceiling)"
  "profile25|rgb,slam,imu|profile25 — RGB10+SLAM20 (no eye)"
  "profile28|$ALLS|profile28 — all sensors (RGB30 SLAM30 eye60)"
  "profile28|slam|profile28 — SLAM-only (max SLAM)"
  "profile15|$ALLS|profile15 — all sensors (RGB30 SLAM30 eye10)"
  "profile23|$ALLS|profile23 — all sensors (RGB30 SLAM10)"
)
